...
export const ws = {
  send: {
    ...
    updateLocation: z.object({ sessionId: z.string(), lat: z.number(), lng: z.number(), zoom: z.number() }),
  },
  receive: {
    locationUpdated: z.object({ lat: z.number(), lng: z.number(), zoom: z.number() }),
    sessionState: z.object({ lat: z.number(), lng: z.number(), zoom: z.number(), trackerActive: z.boolean() }),
